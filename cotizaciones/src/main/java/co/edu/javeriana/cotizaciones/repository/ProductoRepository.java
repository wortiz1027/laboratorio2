...
public class ProductoRepository {
    ...
    public int actualizarProducto(Producto producto) {
        return jdbcTemplate
                .update("update producto set id_catalogo = ?, nombre_producto = ?, precio = ?, tipo_producto = ? where id_producto = ?",
                        producto.getIdCatalogo(), producto.getNombreProducto(), producto.getPrecio(), producto.getTipoProducto(), producto.getIdProducto());
    }
